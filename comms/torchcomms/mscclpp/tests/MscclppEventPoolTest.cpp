...
TEST_F(MscclppEventPoolTest, AcquireReturnsNonNull) {
  ...
  auto pool = std::make_shared<MscclppGpuEventPool>(cuda_api_, /*max_size=*/8);
...
TEST_F(MscclppEventPoolTest, PoolCapEvictsOverflowEvent) {
  ...
  auto pool = std::make_shared<MscclppGpuEventPool>(cuda_api_, /*max_size=*/2);
...
TEST_F(MscclppEventPoolTest, EventsAreCreatedWithTimingDisabled) {
  ...
  auto pool = std::make_shared<MscclppGpuEventPool>(cuda_api_, /*max_size=*/4);
